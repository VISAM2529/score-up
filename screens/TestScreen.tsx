...
//         id: o.id || o._id,                // fallback for missing id
//         text: o.text,
...
//   const [timeRemaining, setTimeRemaining] = useState(test.duration * 60); // duration in minutes to seconds
...
//   // Function to clean and prepare HTML content
