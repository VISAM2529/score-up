...
const TestScreen = () => {
  ...
  const test: ApiTest = route.params?.test; // Full test object passed from TestList
  const navigation = useNavigation<any>();

  // Map API questions to local interface
  const questions: Question[] = test.questions.map((q: ApiQuestion, index: number) => ({
    id: q._id,
    text: q.text,
